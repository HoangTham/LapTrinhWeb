...
// Nếu mình có 2 cái component cùng class thì khi [0] nó sẽ hiển thị component 1 còn [1] thì nó sẽ hiển thị component 2.
        var close_footer = document.getElementById("closeCartbtn");
        var order = document.getElementById("Payment");
...
function addCart1(){
    ...
    var add_cart = document.getElementsByClassName("buttonAddCart");
// for (var i = 0; i < 1; i++) {
var add = add_cart[0];
// add.addEventListener("click", function (event) {
var button = event.target;
var product = button.parentElement.parentElement;
var img = document.getElementById(1).src;
var title = document.getElementById(2).innerText;
var price = document.getElementById(3).innerText;
...
if (cart_title[i].innerText == title && x == 1) {
...
<div class="cart-quantity cart-column">
  <input class="cart-quantity-input" type="number" value="1" onclick = "changeNumber()">
...
for (var i = 0; i < add_cart.length; i++) {
  ...
  add.addEventListener("click", function (event) {
    var button = event.target;
    var product = button.parentElement.parentElement;
    var img = document.getElementById("imgBox").src;
    var title = document.getElementById("nameProduct").innerText;
...
//   Nếu title của sản phẩm bằng với title mà bạn thêm vao giỏ hàng thì sẽ thông cho user.
  ...
  for (var i = 0; i < cart_rows.length; i++) {
    ...
    var price_item = cart_row.getElementsByClassName("cart-price cart-column")[0];
